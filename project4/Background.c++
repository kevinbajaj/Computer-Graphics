...
GLuint Background::indexList_xmin[4] = { 6, 7, 0, 1 };
GLuint Background::indexList_ymin[4] = { 6, 0, 4, 2 };
GLuint Background::indexList_ymax[4] = { 1, 7, 3, 5 };

Background::Background(float cx, float cy, float cz, 
...
void Background::defineBackground(vec2* tex_Coords)
{
...
GLuint Background::defineTexture(const char* texImageSource)
{
...
void Background::getMCBoundingBox(double* xyzLimits) const
{
...
// Establish current texture and any modified properties
	...
	// tell fragment shader we are rendering the Background
