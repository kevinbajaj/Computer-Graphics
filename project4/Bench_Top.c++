...
GLuint Bench_Top::indexList_xmin[4] = { 6, 7, 0, 1 };
GLuint Bench_Top::indexList_ymin[4] = { 6, 0, 4, 2 };
GLuint Bench_Top::indexList_ymax[4] = { 1, 7, 3, 5 };

Bench_Top::Bench_Top(float cx, float cy, float cz, 
...
void Bench_Top::defineBench_Top()
{
...
GLuint Bench_Top::defineTexture(const char* texImageSource)
{
...
void Bench_Top::getMCBoundingBox(double* xyzLimits) const
{
	xyzLimits[0] = xmin;
	xyzLimits[1] = xmax;
	xyzLimits[2] = ymin;
...
// Establish current texture and any modified properties
	...
	// tell fragment shader we are rendering the Bench_Top
