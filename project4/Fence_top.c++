...
GLuint Fence_top::indexList_xmin[4] = { 6, 7, 0, 1 };
GLuint Fence_top::indexList_ymin[4] = { 6, 0, 4, 2 };
GLuint Fence_top::indexList_ymax[4] = { 1, 7, 3, 5 };

Fence_top::Fence_top(float cx, float cy, float cz, 
...
void Fence_top::defineFence_top(vec2* tex_Coords)
{
...
GLuint Fence_top::defineTexture(const char* texImageSource)
{
...
void Fence_top::getMCBoundingBox(double* xyzLimits) const
{
...
// Establish current texture and any modified properties
	...
	// tell fragment shader we are rendering the Fence_top
